...
import tech.carcadex.kotlinbukkitkit.tooling.wizard.bukkit.*
import tech.carcadex.kotlinbukkitkit.tooling.wizard.utils.*
        ...
        JPanel().apply {
            ...
            add(table {
                tr(
                    ...
                    td(JComboBox(ServerVersion.values().reversedArray()).apply { serverApiVersionCB = this })
                    td(JLabel("Server:"))
                    td(JComboBox(ServerType.values()).apply { serverForkCB = this })
                    td(JLabel("KotlinBukkitKit:"))
