...
import tech.carcadex.kotlinbukkitkit.tooling.wizard.creator.*
import tech.carcadex.kotlinbukkitkit.tooling.wizard.utils.backgroundTask
import tech.carcadex.kotlinbukkitkit.tooling.wizard.utils.get
import tech.carcadex.kotlinbukkitkit.tooling.wizard.utils.invokeLater
...
class KBAPIModuleBuilder : ModuleBuilder() {
    ...
    override fun setupRootModel(rootModel: ModifiableRootModel) {
        ...
        project.backgroundTask("Setting Up Project") { progress ->
            ...
            generateConfigFile(root).createIfNotExists()
            generateMessagesFile(root).createIfNotExists()
